...
const SingleAddBankAccountScreen = ({ navigation }) => {
  ...
  const handleSave = async () => {
    try {
      ...
      if (firebaseResult.success) {
        ...
        navigation.navigate("SingleBankAccountSuccess", {
          bankName: selectedBank?.name,
                ...
                >
                  <View style={{
                    ...
                    {item.logo ? (
                      ...
                      <Feather name="briefcase" size={16} color="#028550" />
                    )}
                  </View>
                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    {selectedBank?.id === item.id && (
                      <Feather name="check" size={20} color="#028550" />
                    )}
                  </View>
                </TouchableOpacity>
              )}
...
export default SingleAddBankAccountScreen;
