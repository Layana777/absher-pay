...
/**
 * Single (Customer) Upcoming Payment Details Screen
 * Displays detailed information about a payment and provides payment actions
 *
 * IMPORTANT: This screen uses ONLY Single and common components
 * NO Business components are imported here
 */
const UpcomingPayDetailsScreen = ({ navigation, route }) => {
  const { payment, primaryColor = COLORS.singlePrimary } = route.params || {};
  const user = useUser();
  ...
  const handleSchedulePayment = async (paymentDate) => {
    ...
    try {
      ...
      if (isScheduled && existingScheduledBill) {
        ...
        console.log("✅ Scheduled bill updated:", scheduledBill.id);
      } else {
            ...
            <View className="bg-white rounded-t-3xl">
              ...
              <View className="px-6 pb-8">
                ...
                <View className="bg-gray-50 rounded-2xl p-4 mb-6">
                  ...
                  <View className="flex-row justify-between items-center">
                    ...
                    <View className="flex-row items-center">
                      ...
                      <SvgIcons name={"SARGreen"} size={20} />
                    </View>
                  </View>
                  {enrichedPayment.penaltyInfo && (
                ...
                <View className="gap-3">
                  ...
                  <TouchableOpacity
                    onPress={() => setShowConfirmModal(false)}
                    className="rounded-2xl py-4 border-2 border-red-500 items-center justify-center"
                    activeOpacity={0.8}
                  >
                    <Text className="text-red-500 text-lg font-bold">إلغاء</Text>
                  </TouchableOpacity>
                </View>
