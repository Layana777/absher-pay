...
/**
 * Payment Secondary Actions Component
 * Provides secondary action buttons (PDF, Share, Reminder)
 *
 * @param {Function} onDownloadPDF - Callback for downloading PDF
 * @param {Function} onShare - Callback for sharing payment
 * @param {Function} onSetReminder - Callback for setting reminder
