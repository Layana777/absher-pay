      ...
      <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={{
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', direction: "ltr" }}>
            ...
            <Text style={{ color: '#1f2937', fontSize: 30, fontWeight: 'bold' }}>
              {balance}
            </Text>
          </View>
        </View>
        ...
        <View style={{
          ...
          <Text style={{ color: '#374151', fontSize: 16, fontWeight: '600', marginBottom: 24, textAlign: 'center' }}>
            تعبئة الحساب البنكي
          </Text>

          {/* Bank Selection */}
          <View style={{ marginBottom: 20 }}>
            <Text style={{ width: '100%', color: '#6b7280', fontSize: 14, marginBottom: 8, writingDirection: "rtl", textAlign: 'right' }}>
              إضافة
            </Text>
            <Text style={{ width: '100%', color: '#374151', fontSize: 14, fontWeight: '600', marginBottom: 8, writingDirection: "rtl", textAlign: 'right' }}>
              اسم البنك
            </Text>
            <TouchableOpacity
            ...
            >
              <Text style={{ fontSize: 14, color: selectedBank ? '#1f2937' : '#9ca3af', flex: 1, textAlign: 'right' }}>
          ...
          <View style={{ marginBottom: 20, direction: "ltr" }}>
            ...
            />
            {ibanError ? (
              <Text style={{ width: '100%', color: '#ef4444', fontSize: 12, marginTop: 4, textAlign: 'right' }}>
                {ibanError}
              </Text>
            ) : iban.length > 0 ? (
              <Text style={{ width: '100%', color: '#9ca3af', fontSize: 12, marginTop: 4, textAlign: 'right' }}>
          ...
          {/* Account Owner Name */}
          <View style={{ marginBottom: 20 }}>
            <Text style={{ width: '100%', color: '#374151', fontSize: 14, fontWeight: '600', marginBottom: 8, textAlign: 'right' , writingDirection: "rtl"}}>
              اسم صاحب الحساب
            </Text>
            <TextInput
              style={{
        ...
        <View style={{
          ...
          <Text style={{ color: '#0055aa', fontSize: 12, textAlign: 'center', lineHeight: 20 }}>
            سيتم تحويل المبالغ إلى حسابك البنكي خلال 24 ساعة من وقت تأكيد العملية
          </Text>
        </View>
      </ScrollView>
